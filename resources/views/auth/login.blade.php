...
<body class="bg-gradient-to-br from-orange-50 to-orange-100 min-h-screen flex items-center justify-center">
    <div class="w-full max-w-md bg-white rounded-2xl shadow-xl p-8">
        <div class="text-center mb-8">
            ...
            <h1 class="text-3xl font-bold text-orange-900">Masuk</h1>
            <p class="text-gray-600 mt-2">Silahkan login ke akun Anda</p>
        </div>
        ...
        <div class="mt-4 text-center text-sm text-gray-600">
            Belum punya akun? 
            <a href="register" class="text-orange-600 hover:underline">
                Daftar Sekarang
            </a>
        </div>
    </div>
